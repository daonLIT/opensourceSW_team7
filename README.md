...
이 프로젝트에서 저는 다음 역할을 맡았습니다.

- 아이디어 제안 및 핵심 기능 방향 정리
- 기능 설계 보조 및 화면(UX) 흐름 설계
- 백엔드 보조 개발 참여
- 발표자료 제작 및 최종 발표 진행

### 백엔드에서 직접 구현한 부분
- 식품 날짜가 하루 단위로 갱신/감소되도록 처리하는 로직 구현
- 남은 보관 기간을 사용자 화면에서 확인할 수 있도록 연동

### 배운 점
- 백엔드를 처음 다뤄본 프로젝트였지만,
  날짜 계산/갱신 로직을 직접 구현하면서
  API-DB-화면이 연결되는 전체 흐름을 익혔습니다.
